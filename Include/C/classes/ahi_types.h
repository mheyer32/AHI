...
#define AHIST_C_DECODE(x)	(((((x)>>15)&62)|(((x)>>1)&1))+1)
...
# define _AHIST_IE		AHIST_E_BIG
#else
# define _AHIST_IE		AHIST_E_LITTLE
#endif

#if _AHI_FLOAT_WORD_ORDER == _AHI_BIG_ENDIAN
# define _AHIST_FE		AHIST_E_BIG
#else
# define _AHIST_FE		AHIST_E_LITTLE
#endif
...
namespace AHI {
  ...
  enum {
    ...
    _AHIST(M8S,			(_AHIST_IE|AHIST_T_BYTE|_AHIST_CH_1)),

    /* Mono, 16 bit signed (WORD) */
    _AHIST(M16S,		(_AHIST_IE|AHIST_T_WORD|_AHIST_CH_1)),

    /* Stereo, 8 bit signed (2×BYTE) */
    _AHIST(S8S,			(_AHIST_IE|AHIST_T_BYTE|_AHIST_CH_2)),

    /* Stereo, 16 bit signed (2×WORD) */
    _AHIST(S16S,		(_AHIST_IE|AHIST_T_WORD|_AHIST_CH_2)),

    /* Mono, 32 bit signed (LONG) */
    _AHIST(M32S,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_1)),

    /* Stereo, 32 bit signed (2×LONG) */
    _AHIST(S32S,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_2)),

    /* Mono, 8 bit unsigned (UBYTE) -- obsolete in V4, removed in V5,
     * resurrected in V7 */
    _AHIST(M8U,			(_AHIST_IE|AHIST_T_UBYTE|_AHIST_CH_1)),
  };
  ...
  enum {
    ...
    _AHIST(F1,			(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_1)),
    _AHIST(F2,			(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_2)),
    _AHIST(F2_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_2_1)),
    _AHIST(F3,			(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_3)),
    _AHIST(F3_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_3_1)),
    _AHIST(F4,			(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_4)),
    _AHIST(F4_PROLOGIC,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_4_PROLOGIC)),
    _AHIST(F4_MOVIE,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_4_MOVIE)),
    _AHIST(F4_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_4_1)),
    _AHIST(F4_1_MOVIE,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_4_1_MOVIE)),
    _AHIST(F5_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_5_1)),
    _AHIST(F5_1_MOVIE,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_5_1_MOVIE)),
    _AHIST(F7_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_7_1)),
    _AHIST(F3D1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_3D1)),
    _AHIST(F3D2,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_3D2)),
    _AHIST(FFT1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_1)),
    _AHIST(FFT2,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_2)),
    _AHIST(FFT2_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_2_1)),
    _AHIST(FFT3,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_3)),
    _AHIST(FFT3_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_3_1)),
    _AHIST(FFT4,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_4)),
    _AHIST(FFT4_PROLOGIC,	(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_4_PROLOGIC)),
    _AHIST(FFT4_MOVIE,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_4_MOVIE)),
    _AHIST(FFT4_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_4_1)),
    _AHIST(FFT4_1_MOVIE,	(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_4_1_MOVIE)),
    _AHIST(FFT5_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_5_1)),
    _AHIST(FFT5_1_MOVIE,	(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_5_1_MOVIE)),
    _AHIST(FFT7_1,		(_AHIST_FE|AHIST_T_FLOAT|_AHIST_CH_FT_7_1)),
    ...
    _AHIST(L1,			(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_1)),
    _AHIST(L2,			(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_2)),
    _AHIST(L2_1,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_2_1)),
    _AHIST(L3,			(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_3)),
    _AHIST(L3_1,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_3_1)),
    _AHIST(L4,			(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_4)),
    _AHIST(L4_PROLOGIC,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_4_PROLOGIC)),
    _AHIST(L4_MOVIE,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_4_MOVIE)),
    _AHIST(L4_1,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_4_1)),
    _AHIST(L4_1_MOVIE,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_4_1_MOVIE)),
    _AHIST(L5_1,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_5_1)),
    _AHIST(L5_1_MOVIE,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_5_1_MOVIE)),
    _AHIST(L7_1,		(_AHIST_IE|AHIST_T_LONG|_AHIST_CH_7_1)),
