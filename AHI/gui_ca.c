...
/* PAGE 2 */
    PAGE_Add, HLayoutObject,
      ...
      LAYOUT_AddChild, VLayoutObject,
        ...
        ChooserEnd,
        CHILD_Label, LabelObject,
          LABEL_Text,           msgGlobOptDebugLevel,
        LabelEnd,
