...
namespace AHI {
  ...
  enum {
    ...
    _AHIST(MPEG2_AAC_LC,	(AHIST_D_COMPRESSED|0x05)),
    _AHIST(MPEG2_AAC_MAIN,	(AHIST_D_COMPRESSED|0x08)),
    _AHIST(MPEG2_AAC_SSR,	(AHIST_D_COMPRESSED|0x09)),
    _AHIST(MPEG4_AAC_LTP,	(AHIST_D_COMPRESSED|0x0c)),
    _AHIST(MPEG4_AAC_HE,	(AHIST_D_COMPRESSED|0x0d)),
    _AHIST(AC3,			(AHIST_D_COMPRESSED|0x10)),
    _AHIST(DTS,			(AHIST_D_COMPRESSED|0x11)),
    _AHIST(WMA_V1,		(AHIST_D_COMPRESSED|0x14)),
    _AHIST(WMA_V2,		(AHIST_D_COMPRESSED|0x15)),
    _AHIST(VORBIS,		(AHIST_D_COMPRESSED|0x18))
  };
