...
${SQUIRT} --dest boot:System/ ${SQUIRT_HOST} $PWD/_build/m68k-amigaos-ahiusr-7.0.zip

${SQUIRT_EXEC} ${SQUIRT_HOST} xadUnFile boot:system/m68k-amigaos-ahiusr-7.0.zip DEST RAM: OVERWRITE
